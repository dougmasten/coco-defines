...
SDC_STR_DELETE          equ "X:             ; Delete file or directory
...
TIMER_INTERRUPT         equ %00100000
HSYNC_INTERRUPT         equ %00010000
VSYNC_INTERRUPT         equ %00001000
SERIAL_INTERRUPT        equ %00000100
KEY_INTERRUPT           equ %00000010
